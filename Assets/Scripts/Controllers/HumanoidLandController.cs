...
public class HumanoidLandController : MonoBehaviour
{
    ...
    private Vector3 AscendStairs(Vector3 calculatedStepInput)
    {
        ...
        {
            float calculatedVelDistance = _isFirstStep ? (_rigidbody.linearVelocity.magnitude * _firstStepVelocityDistanceMultiplier) + _capsuleCollider.radius : _capsuleCollider.radius;
